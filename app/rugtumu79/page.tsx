        ...
        <div className="space-y-2 pb-4 pt-6 md:space-y-8">
          <h1 className="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
            ...
            <div className="space-y-2 pb-4 pt-6 md:space-y-8">
              ...
              <h2>
                "Salt hedefe yönelmişlik, hedefe varmak için aşılması gereken mekansal aralığı olabildiğince hızlı aşılması gereken bir engele dönüştürür. Salt hedefe yönelmek aradaki mekanı bütün anlamından yoksun bırakır. İçini boşaltarak kendi başına bir değeri olmayan bir koridora çevirir.
                Mekansal aralığı aşmak için gerekli olan zamansal aralığın tamamen ortadan kaldırılması girişimidir hızlanma. Yolun zengin semantiği ortadan kalkar. Yolun bir kokusu yoktur artık. Hatta yol da ortadan kalkar. Hızlanma dünyanın semantik açıdan kısırlaşmasına yol açar.
                Mekan ve zaman artık çok da anlamlı değildir."
              </h2>
